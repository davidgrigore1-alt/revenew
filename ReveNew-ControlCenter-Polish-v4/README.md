# ReveNew — Control Center Polish V4
...
`C:\Projects\ReveNew\ReveNew-ControlCenter-Polish-v4`

Then from CMD:

```bat
cd /d C:\Projects\ReveNew
powershell -NoProfile -ExecutionPolicy Bypass -File ".\ReveNew-ControlCenter-Polish-v4\apply.ps1"
```
...
```bat
powershell -NoProfile -ExecutionPolicy Bypass -File ".\ReveNew-ControlCenter-Polish-v4\verify.ps1" -Build
```

## Rollback

```bat
powershell -NoProfile -ExecutionPolicy Bypass -File ".\ReveNew-ControlCenter-Polish-v4\rollback.ps1"
```
