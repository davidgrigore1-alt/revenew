...
const pathways = [
  ...
  { step: "04", title: "Aprobă documentele", description: "Revizuiește drafturile și păstrează controlul uman înaintea oricărei trimiteri externe.", href: "/outreach", action: "Deschide Studio de follow-up" }
];
...
const faqGroups = [
  ...
  {
    title: "Responsabilitate și execuție",
    items: [
      ["De ce este important responsabilul?", "Atribuirea responsabilului elimină ambiguitatea: echipa știe cine continuă conversația, iar managementul poate vedea lucrările neatribuite sau blocate."],
  ...
  },
  {
    ...
    items: [
      ["Cum sunt pregătite documentele?", "Drafturile folosesc contextul oportunității și al companiei. Ele ajung în Studio de follow-up pentru revizuire, adaptare și aprobare."],
      ["ReveNew trimite automat mesaje?", "Nu. Interfața diferențiază pregătirea, aprobarea și confirmarea trimiterii. Acțiunile externe rămân sub controlul utilizatorului și al politicilor spațiului de lucru."],
      ...
      ["Unde verific aprobările?", "Documentele se revizuiesc în Studio de follow-up, iar cererile guvernate apar în Setări → Echipă și guvernanță, numai pentru utilizatorii autorizați."]
    ]
  },
  {
    ...
    items: [
      ...
      ["Cum sunt separate datele?", "Datele sunt asociate spațiului de lucru curent, iar accesul este controlat pe server și prin politicile existente. Interfața nu modifică aceste reguli."],
