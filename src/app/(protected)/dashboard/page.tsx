  ...
  try {
    ...
    return (
      <main className="mx-auto grid w-full max-w-[1440px] gap-8 px-4 py-6 pb-24 sm:px-6 sm:py-7 lg:px-8 lg:pb-10">
        ...
        <DashboardSection eyebrow="Prioritatea zilei" title="Ce necesită atenție acum" description="Acțiunile scadente au prioritate, urmate de oportunitățile fără ownership, contact sau următor pas." action={<Button href="/today" variant="ghost" size="small">Vezi activitatea mea <ArrowRightIcon className="h-4 w-4" aria-hidden="true" /></Button>}>
          <DashboardTable
            rows={attentionRows}
