      ...
      >
        {flowSteps.map((step, index) => {
          ...
          return (
            ...
            >
              <span className={`flex h-6 w-6 shrink-0 items-center justify-center rounded-full border text-[0.6875rem] font-semibold tabular-nums ${active ? "border-[rgb(var(--primary))] bg-[rgb(var(--primary-muted))] text-[rgb(var(--primary))]" : "border-[rgb(var(--border-strong))] text-[rgb(var(--text-faint))]"}`}>
                {index + 1}
              </span>
