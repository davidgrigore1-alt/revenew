      ...
      <div className="mx-auto max-w-[1280px] px-4 py-16 sm:px-6 md:py-20 lg:px-8">
        ...
        <Reveal delay={80} className="mt-9 grid overflow-hidden rounded-[1.1rem] border border-[rgb(var(--border-strong))] bg-[rgb(var(--surface))] shadow-card lg:grid-cols-[1.35fr_0.65fr]">
          ...
          <aside className="bg-[rgb(var(--surface-subtle))] p-5" aria-label="Composer de follow-up ilustrativ">
            ...
            <div className="mt-5 overflow-hidden rounded-card border border-[rgb(var(--border))] bg-[rgb(var(--surface))]"><div className="grid grid-cols-[4rem_1fr] border-b border-[rgb(var(--border))] px-4 py-3 text-xs"><span className="text-[rgb(var(--text-muted))]">Către</span><span className="font-medium">elena@arcadia.ro</span></div><div className="grid grid-cols-[4rem_1fr] border-b border-[rgb(var(--border))] px-4 py-3 text-xs"><span className="text-[rgb(var(--text-muted))]">Subiect</span><span className="font-medium">Următorul pas pentru extinderea serviciilor</span></div><div className="space-y-3 p-4 text-xs leading-5"><p>Bună ziua, Elena,</p><p>Revin cu privire la propunerea discutată și la termenul pentru următoarea decizie.</p><p>Putem confirma responsabilul și intervalul potrivit pentru revizuire?</p><p>Mulțumesc,<br />Mara</p></div></div>
            ...
            <button type="button" className="mt-4 inline-flex w-full items-center justify-center gap-2 rounded-button bg-[rgb(var(--primary))] px-4 py-2.5 text-xs font-semibold text-[rgb(var(--primary-foreground))]"><DocumentTextIcon className="h-4 w-4" />Revizuiește și aprobă</button>
          ...
          <Reveal delay={80} className="mt-9 grid gap-4 lg:grid-cols-[1.35fr_0.65fr]">
            <div className="grid gap-4">
              ...
              <article className="rounded-[1.1rem] border border-[rgb(var(--border-strong))] bg-[rgb(var(--surface))] p-5 shadow-card">
                ...
                <div className="mt-5 grid grid-cols-[2.5rem_1fr] gap-3"><div className="flex h-36 flex-col justify-between pb-5 text-right text-[0.62rem] text-[rgb(var(--text-faint))]"><span>100</span><span>75</span><span>50</span><span>25</span><span>0</span></div><div className="relative flex h-36 items-end justify-around border-b border-l border-[rgb(var(--border))] bg-[linear-gradient(to_bottom,rgb(var(--border)/0.55)_1px,transparent_1px)] bg-[length:100%_25%] px-4">{bars.map(([active,review,blocked],index) => <div key={months[index]} className="flex h-full w-9 flex-col justify-end"><span className="bg-[rgb(var(--chart-blocked))]" style={{height:String(blocked)+"%"}} /><span className="bg-[rgb(var(--chart-secondary))]" style={{height:String(review)+"%"}} /><span className="bg-[rgb(var(--product-blue))]" style={{height:String(active)+"%"}} /><span className="absolute translate-y-5 text-[0.62rem] text-[rgb(var(--text-faint))]">{months[index]}</span></div>)}</div></div>
