...
export function BuyerDemoRail() {
  ...
  return (
    <aside className="sticky top-0 z-40 border-b border-[rgb(var(--border-strong))] bg-[rgb(var(--surface-elevated)/0.99)] shadow-card" aria-labelledby="buyer-demo-current-step" aria-live="polite">
