      ...
      >
        ...
        {visible.length ? (
          <div className="control-center-workbench product-work-surface mt-3 grid min-w-0 overflow-hidden lg:grid-cols-[minmax(0,1.08fr)_minmax(350px,0.92fr)]">
            ...
            <div className="control-center-case-list min-w-0 lg:max-h-[min(660px,64vh)] lg:overflow-y-auto lg:overscroll-contain">
            ...
            <div
              ...
              className="control-center-case-inspector min-w-0 border-t border-[rgb(var(--border))] bg-[rgb(var(--surface))] lg:max-h-[min(660px,64vh)] lg:overflow-y-auto lg:overscroll-contain lg:border-l lg:border-t-0"
            >
              <p
                role="status"
                className="sr-only"
