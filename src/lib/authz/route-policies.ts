...
export const routePolicies: Array<{ prefix: string; permission: Permission }> = [
  ...
  { prefix: "/companies", permission: "workspace.read" },
  { prefix: "/contacts", permission: "workspace.read" },
  { prefix: "/activation", permission: "workspace.read" },
  { prefix: "/crm", permission: "workspace.read" },
