...
export const appSectionIndex: AppSectionSearchResult[] = [
  ...
  { id: "audit", group: "Secțiuni", title: "Audit de recuperare venituri", context: "Raport · Audit controlat", href: "/reports/revenue-recovery-audit", aliases: ["audit", "audit venituri", "revenue recovery audit"], keywords: ["raport", "recuperare", "dovezi"] },
