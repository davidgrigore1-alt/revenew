...
export const appSectionIndex: AppSectionSearchResult[] = [
  ...
  { id: "intelligence", group: "Secțiuni", title: "Inteligență operațională", context: "Secțiune · Recomandări, descoperiri și dovezi", href: "/ai", aliases: ["inteligență", "recomandări", "dovezi", "analiză", "descoperiri", "descoperiri comerciale", "semnale comerciale", "oportunități neurmărite"], keywords: ["recomandare", "dovadă", "ai", "risc", "semnal", "neurmărit"] },
  { id: "audit-start", group: "Secțiuni", title: "Începe audit controlat", context: "Secțiune · Pregătire sigură a datelor", href: "/audit/start", aliases: ["audit controlat", "incepe audit", "începe audit", "start audit", "date audit", "date anonimizate", "cazuri comerciale", "plan audit", "audit wizard"], keywords: ["20–50 cazuri", "anonimizare", "plan sigur"] },
  { id: "audit", group: "Secțiuni", title: "Audit de recuperare venituri", context: "Raport · Concluzii și dovezi", href: "/reports/revenue-recovery-audit", aliases: ["audit venituri", "raport audit", "revenue recovery audit"], keywords: ["raport", "recuperare", "dovezi", "valoare expusă"] },
  ...
  { id: "settings-identity", group: "Secțiuni", title: "Identitate spațiu de lucru", context: "Setări · Afișare locală", href: "/settings#identitate", aliases: ["branding", "brand", "identitate", "logo", "siglă", "sigla", "marca firmei", "cum adaug logo", "inițiale", "moneda", "monedă", "valută", "limbă", "workspace name", "nume firmă"], keywords: ["industrie", "ron", "eur", "nume afișat", "preferință", "compania activă"] },
