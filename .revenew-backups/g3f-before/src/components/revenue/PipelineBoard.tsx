...
function OpportunityCard({ opportunity, columnId, isPending, onStatusChange }: {
  ...
  return (
    <article className="product-lift group min-w-0 rounded-control border border-[rgb(var(--border-strong)/0.72)] bg-[rgb(var(--surface))] p-2.5 hover:bg-[rgb(var(--surface-elevated))] motion-reduce:transform-none">
