...
export default async function TodayPage() {
  ...
  return (
    <PageShell eyebrow="Sistem de execuție" title="Astăzi" description="Ce necesită intervenție, ce este pregătit și unde așteptarea este acțiunea corectă."><div className="grid gap-10">
